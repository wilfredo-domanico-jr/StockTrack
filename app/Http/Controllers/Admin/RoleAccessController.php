    ...
    public function update(HttpRequest $request, $roleID)
    {
        ...
        if (Gate::allows('AuthorizeAction', ['ADMIN'])) {
            ...
            RolePermission::where('ROLE_ID', $roleID)->update([
                ...
                'ADD_PRODUCT_CATEGORY' => $request->addProductCategory,
                'EDIT_PRODUCT_CATEGORY' => $request->editProductCategory,
                'DELETE_PRODUCT_CATEGORY' => $request->deleteProductCategory,
                'INVENTORY' => $request->inventory,
                'CREATE_PRODUCT_TRANSFER' => $request->createProductTransfer,
                'RECEIVE_PRODUCT_TRANSFER' => $request->receiveProductTransfer,
