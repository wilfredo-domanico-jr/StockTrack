...
const status = ref([
  { count: props.receivedTransfer, label: "RECEIVED TRANSFER", class: 'bg-green-400 border border-gray-200'},
  { count: props.pendingToReceive, label: "PENDING TO RECEIVE", class: 'bg-blue-400 border border-gray-200' },
  { count: props.transferedAsset, label: "TRANSFERED ASSET", class: 'bg-violet-400 border border-gray-200' },
  { count: props.pendingTransfer, label: "PENDING TRANSFER", class: 'bg-red-400 border border-gray-200' },
]);
            ...
            <div class="grid grid-cols-4 gap-4 mb-4">
              ...
              >
                <div class="flex flex-col gap-4 h-full">
                    <div class="h-1/2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
