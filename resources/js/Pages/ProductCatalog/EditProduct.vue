...
let form = reactive({
  ...
  dimension: productDetailData.DIMENSION ? productDetailData.DIMENSION : 'N/A',
  ...
  description: productDetailData.ASSET_DESCRIPTION ? productDetailData.ASSET_DESCRIPTION : 'N/A',
...
const submit = () => {
  ...
  Inertia.post(route("ProductCatalog.updateProduct", { assetId: productDetailData.ASSET_ID }), form, {
            ...
            <BreezeValidationErrors class="mb-4" />
              ...
              <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-1">
                  <div class="mb-5">
                    <Label for="category" value="Asset Image" />

                    <div class="mb-4 p-1">

                        <template v-if="form.old_image">
                              <img class="rounded-md w-full h-60"
