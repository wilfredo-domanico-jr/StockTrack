...
const submit = () => {
  form.put(route("Supplier.update", { supplierID: supplierData.SUPPLIER_ID }), {
   onSuccess: () => {
    // form.reset();
   } ,
          ...
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form @submit.prevent="submit" class="max-w-full mx-auto">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  <div class="mb-5">
                    <BreezeLabel value="Supplier Name" important="true" />
                    <BreezeInput
                      type="text"
                  ...
                  <div class="mb-5">
                    <BreezeLabel value="Contact Name" important="true" />
                    <BreezeInput
                      type="text"
                      class="mt-1 block w-full"
                    ...
                    <div class="mb-5">
                    <BreezeLabel value="Contact Number" important="true" />
                    <BreezeInput
                      type="text"
                      class="mt-1 block w-full"
                ...
                <div>
                  <div class="mb-5">
                    <BreezeLabel value="Supplier Type" important="true" />


                    <SelectInput v-model="form.supplierType" required>
                      <option value="" selected disabled>Select Supplier Type</option>
                      <option v-for="suppliertType in suppliertTypes" :key="suppliertType.id" :value="suppliertType.TYPE">
                        {{ suppliertType.TYPE }}
                      </option>
                    </SelectInput>
                  </div>
                  ...
                  <div class="mb-5">
                    <BreezeLabel value="Email Adress" important="true" />
                  ...
                  <div class="mb-5">
                    <BreezeLabel value="Address" important="true" />
                    <BreezeInput
                      type="text"
                      class="mt-1 block w-full"
