...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <PageHeader label="Inventory ( Receive - History )" />
        </template>
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <tr
                                            v-for="receiving in receive.data"
                                            :key="receiving.INDEX_ID"
                                        ...
                                        >
                                            ...
                                            >
                                                <ViewButtonLink
                                                    :href="
                                                        route(
                                                            'Inventory.Receive.historyShow',
                                                            {
                                                                assetTransNo:
                                                                    receiving.ASSET_TRANSFER_NO,
                                                            }
                                                        )
                                                    "
                                                >
                                            ...
                                            <td class="px-6 py-4">
                                                {{ receiving.TRANSACTION_DATE }}
                                            </td>
                                            <td class="px-6 py-4">
                                                {{
                                                    receiving.TRANSFERED_LOCATION_ID
                                                }}
                                            </td>
                                            <td class="px-6 py-4">
                                                {{
