        ...
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="flex mb-4">
                       ...
                       <Link :href="route('Inventory.Receive.index')" class="py-2.5 px-5 me-2 mb-2
                ...
                <form class="max-w-full mx-auto">
                        ...
                        <div class="flex gap-4">
                          ...
                          <button @click.prevent="accept(assetTransfer.ASSET_TRANSFER_NO)" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                              <i class="fa-solid fa-check"></i> Accept
                          </button>

                             <button @click.prevent="reject(assetTransfer.ASSET_TRANSFER_NO)" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
