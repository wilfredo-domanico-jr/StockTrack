...
const isDuplicateSerial = (serialNo, index) => {
  return form.serialNo.some((item, i) => item.number === serialNo && i !== index);
};
...
const getInventory = (serialNo, index) =>{
  ...
  axios.post(route('Axios.getInventoryItem',{serialNo,userLocation}))
  .then(response => {
          ...
          <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form @submit.prevent="submit" class="max-w-full mx-auto">
                        ...
                        <div class="grid grid-cols-2 gap-4 w-1/2">
                         ...
                         <div class="mb-5">
                          <Label value="Transfer Location" important="true" />
                          <SelectInput v-model="form.transferTo" required class="w-1/2 text-center">
                        ...
                        <div class="mb-5">
                          ...
                          <Input
                            ...
                            class="mt-1 block w-1/2 text-center" required
                            />
                        </div>
                      ...
                      <div class="relative overflow-x-auto mb-4">
                        ...
                        <table class="text-center w-full text-sm rtl:text-right text-gray-500 mb-4">
                          ...
                          <tbody v-for="(row, index) in totalRows" :key="index">
                            <tr class="bg-white">
                              <!-- Table data -->
                                <th  class="px-2" scope="row">
                                  ...
                                  v-model="form.serialNo[index].number"
                                  @change="getInventory(form.serialNo[index].number, index)"
                                  required
                                  autofocus
                                  />
                                </th>
                              ...
                              <td class="px-2">
                                  <Input
                                    type="text"
                                    class="mt-1 block w-full text-center"
                                    v-model="form.serialNo[index].assetName"
                                    disabled
                                  />
                              </td>
                              <td class="px-2">
                                  <Input
                                    type="text"
                                    class="mt-1 block w-full text-center"
                                    v-model="form.serialNo[index].assetSubtype"
                                    disabled
                                  />
                              </td>
                              <td class="px-2">
                                ...
                                type="text"
                                class="mt-1 block w-full text-center"
                                v-model="form.serialNo[index].assetTag"
                                disabled
                              />
                              </td>
                              <td class="px-2">
                                ...
                                type="text"
                                class="mt-1 block w-full text-center"
                                v-model="form.serialNo[index].assetCondition"
                                disabled
                              />
                              </td>
                        ...
                        <div class="flex gap-4">
                          <SubmitButton> <i class="fa-solid fa-arrow-up-from-bracket"></i> Submit </SubmitButton>

                          <Link :href="route('Inventory.AssetTransfer.index')"
