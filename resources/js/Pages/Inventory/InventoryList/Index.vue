...
watch(search, value =>{
    Inertia.get('/inventory',{ search: value },
    {preserveState: true}
    )
});
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="flex justify-end mb-6">
                            ...
                            <input v-model="search" type="text" placeholder="Search...." class="mr-4 w-full max-w-md relative px-6 py-3 rounded focus:shadow-outline">
                           ...
                           <div class="relative overflow-x-auto">
                                ...
                                >
                                    ...
                                    <tbody>
                                            ...
                                            <template v-if="inventories.data && inventories.data.length > 0">
                                            <!-- Loop through inventories.data array -->
                                            <tr v-for="inventory in inventories.data" :key="inventory.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">

                                                   <td class="px-6 py-4">
                                                        <ViewButtonLink :href="route('Inventory.InventoryList.show',{ inventoryID: inventory.INVENTORY_ID })">
