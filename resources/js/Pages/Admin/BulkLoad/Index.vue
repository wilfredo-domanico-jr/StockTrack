        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
                ...
                <li v-for="(tab, index) in tabs" :key="index" class="me-2">
                  <button
                    ...
                    :class="{
                      ...
                      'border-blue-600 text-blue-600': activeTab === tab.name,
                      'hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300': activeTab !== tab.name
                    }"
                    :id="tab.id"
                  ...
                  >
                    <i :class="`w-4 h-4 me-2 text-blue-600 ${tab.icon}`"></i>
                    {{ tab.title }}
                  </button>
                </li>
              </ul>
            ...
            <div id="default-tab-content">
              <div v-for="(tabContent, index) in tabContents" :key="index" class="flex justify-center">
                <div
                ...
                >
                        ...
                        <h1 class="text-blue-600 text-center mb-4 text-xl">
                        ...
                        <div class="flex gap-4 items-center">
                            <label class="block mb-2 font-medium text-gray-900">Upload file:</label>
                            <a :href="tabContent.exportLink" class="block  mb-2 font-medium text-blue-600 hover:underline">Download Template</a>
                        </div>

                      <form @submit.prevent="submit(tabContent.importLink)">

                        <input @input="form.submittedFile = $event.target.files[0]"
                        ...
                        accept=".xls, .xlsx"
                        type="file">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">.xls, .xlsx only</p>


                      <div class="flex justify-center mt-4">
                        <SubmitButton> <i class="fa-solid fa-upload"></i> Import </SubmitButton>
                      </div>
