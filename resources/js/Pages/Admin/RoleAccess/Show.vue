...
const submit = () => {
    form.put(
        route("Admin.RoleAccess.update", {
            roleID: instance.props.roleSelected,
        })
    );
};
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form @submit.prevent="submit" class="mx-auto">
                            ...
                            <h3 class="mb-4 font-semibold text-gray-900">
                                Check Modules you want the selected role to
                                access
                            </h3>

                            <div class="grid grid-cols-5 gap-4">
                                <ul
                                    class="w-48 text-sm font-medium text-gray-900 bg-white rounded-lg"
                                >
                                ...
                                <ListContainer>
                                    ...
                                    />
                                    <Checkbox
                                        v-model="form.addProduct"
                                        label="Add Product"
                                    />
                                    <Checkbox
                                        v-model="form.editProduct"
                                        label="Edit Product"
                                    />
                                    <Checkbox
                                ...
                                <ListContainer>
                                    ...
                                    />
                                    <Checkbox
                                        v-model="form.addSupplier"
                                        label="Add Supplier"
                                    />
                                    <Checkbox
                                        v-model="form.editSupplier"
                                        label="Edit Supplier"
                                    />
                                    <Checkbox
